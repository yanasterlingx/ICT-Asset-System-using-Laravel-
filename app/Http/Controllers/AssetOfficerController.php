...
class AssetOfficerController extends Controller
{
    /**
    ...
    public function index(Request $request, $id = null)
    {
        ...
        return view('assetofficer.index',compact('assets','depart','id','devices'));
    }
    ...
    public function device(Request $request, $id)
    {
        ...
        return view('assetofficer.index', compact('assets','devices','id','depart'));
    ...
    public function create()
    {
        ...
        $asetoff = Asetofficer::pluck('name', 'id');
        $departments = Department::pluck('deptname','id');
        $devices = Device::pluck('device_name', 'id');
        $brands = Brand::pluck('brand_name', 'id');

        return view('assetofficer.create', compact('asetoff','departments','devices','brands'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('assetofficer.index')
    ...
    {
        return view('assetofficer.show',compact('asset'));
    }
    ...
    {
        $users = Asetofficer::pluck('name', 'id');
        $brands = Brand::pluck('brand_name', 'id');
        $devices = Device::pluck('device_name', 'id');
        $departments = Department::pluck('deptname', 'id');

        return view('assetofficer.edit', compact('users','asset','departments','brands','devices'));
    }
